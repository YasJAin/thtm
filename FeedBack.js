...
function Feedback() {
    ...
    const feedback_type = {
        ...
        'qob': 'Please rate the quality of your car services.',
        'roc': 'Was our car clean?',
        'exp': 'Please rate your overall riding experience.'
    };
            ...
            (<Card>
                <Card.Header>
                    <cite title="Source Title">We are committed to providing you with the best
                        riding experience possible, so we welcome your comments.
                    </cite>
                </Card.Header>
                <Card.Body>
                ...
                <Container className='padding30px'>
                    <Form>
                        <Row>
                            <Col>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    ...
                                    <Form.Control type="text" required placeholder="E.g. john snow" value={nm_value} onChange={e => setNmValue(e.target.value)} />
                        ...
                        <Button className='btn_purp' size="lg" onClick={e=>formSubmit(e)}>Submit</Button>
                    </Form>
                </Container>
            </Card>
            ):(
